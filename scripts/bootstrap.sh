...
if [ -d "$PLUGIN_DIR/context" ]; then
  for context_file in "$PLUGIN_DIR/context"/*.md; do
...
This directory contains deep research outputs generated by the `/jaan-to:research-about` skill.
