...
description: |
  ...
  Maps to: jaan-to:learn-add
allowed-tools: Read, Glob, Grep, Write(.jaan-to/learn/**), Write(context/**), Bash(git add:*), Bash(git commit:*)
...
- `context/*.md` - Context files and lessons
...
- `/jaan-to:learn-add "context/tech" "All new tables need soft delete"`
...
| `context/{name}` | `context/LEARN.md` |
| `context/tech` | `context/tech.md` (constraints section) |
| `context/team` | `context/team.md` (norms section) |
