...
- `.claude/skills/to-jaan-docs-update/LEARN.md` - Past lessons
...
| `.claude/skills/{name}/LEARN.md` | (referenced in skill doc) |
| `jaan-to/hooks/{name}.sh` | `docs/hooks/{name}.md` |
| `jaan-to/config.md` | `docs/config/README.md` |
| `jaan-to/context/*.md` | `docs/config/context.md` |
| `jaan-to/boundaries/*.md` | `docs/config/boundaries.md` |
...
```bash
git log --since="30 days ago" --name-only --pretty=format: -- .claude/skills/ jaan-to/hooks/ jaan-to/config.md jaan-to/context/ jaan-to/boundaries/ | sort -u | grep -v '^$'
```
...
|-----|--------------|--------------|-------------|-------|
| docs/skills/pm/prd-write.md | .claude/skills/jaan-to-pm-prd-write/SKILL.md | 2026-01-25 | 2026-01-10 | 15d stale |

## Missing Documentation

| Code File | Expected Doc | Action |
|-----------|--------------|--------|
| .claude/skills/new-skill/SKILL.md | docs/skills/?/new-skill.md | Create |
...
Read `.claude/skills/to-jaan-docs-update/LEARN.md`:
