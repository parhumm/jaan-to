...
- `.claude/skills/to-jaan-research-about/LEARN.md` - Past lessons
- `.claude/skills/to-jaan-research-about/template.md` - Output format template
...
Read `.claude/skills/to-jaan-research-about/LEARN.md` if it exists:
...
Use template from `.claude/skills/to-jaan-research-about/template.md`:
