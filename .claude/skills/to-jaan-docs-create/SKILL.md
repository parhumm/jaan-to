...
- `.claude/skills/to-jaan-docs-create/template.md` - All templates
- `.claude/skills/to-jaan-docs-create/LEARN.md` - Past lessons
...
Read `.claude/skills/to-jaan-docs-create/LEARN.md` if it exists:
...
Read template for doc type from `.claude/skills/to-jaan-docs-create/template.md`
