...
allowed-tools: Read, Glob, Grep, Write(.claude/skills/**), Write(jaan-to/context/**), Bash(git add:*), Bash(git commit:*)
...
- `.claude/skills/*/LEARN.md` - Skill lessons
...
- Target: skill name, `templates/name`, or `context/name`
- Lesson: the feedback to add

Examples:
- `/to-jaan-learn-add "jaan-to-pm-prd-write" "Always ask about rollback strategy"`
- `/to-jaan-learn-add "context/tech" "All new tables need soft delete"`
...
|----------------|-------------------|
| Skill name (e.g., `jaan-to-pm-prd-write`) | `.claude/skills/{skill}/LEARN.md` |
| System skill (e.g., `to-jaan-skill-create`) | `.claude/skills/{skill}/LEARN.md` |
| `templates/{name}` | `jaan-to/templates/LEARN.md` |
| `context/{name}` | `jaan-to/context/LEARN.md` |
| `context/tech` | `jaan-to/context/tech.md` (constraints section) |
| `context/team` | `jaan-to/context/team.md` (norms section) |
