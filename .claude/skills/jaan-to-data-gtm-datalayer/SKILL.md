...
- `.claude/skills/jaan-to-data-gtm-datalayer/LEARN.md` - Past lessons
- `.claude/skills/jaan-to-data-gtm-datalayer/template.md` - Output template
...
Read `.claude/skills/jaan-to-data-gtm-datalayer/LEARN.md` if it exists:
...
3. Use template from `.claude/skills/jaan-to-data-gtm-datalayer/template.md`
4. Write file
