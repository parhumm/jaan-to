...
- `jaan-to/config.md` - Configuration
- `jaan-to/boundaries/trust-paths.md` - Trust rules
- `.claude/skills/jaan-to-pm-prd-write/template.md` - PRD template
- `.claude/skills/jaan-to-pm-prd-write/LEARN.md` - Past lessons (if exists)
...
Read `.claude/skills/jaan-to-pm-prd-write/LEARN.md` if it exists. Apply lessons:
...
## Step 3: Generate PRD
Use the template from: `.claude/skills/jaan-to-pm-prd-write/template.md`
