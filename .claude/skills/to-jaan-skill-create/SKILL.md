...
allowed-tools: Read, Glob, Grep, Task, WebSearch, Write(.claude/skills/**), Write(docs/**), Edit(jaan-to/**), Bash(git checkout:*), Bash(git branch:*), Bash(git add:*), Bash(git commit:*), Bash(git push:*), Bash(gh pr create:*)
...
- `.claude/skills/to-jaan-skill-create/LEARN.md` - Past lessons
- `.claude/skills/to-jaan-skill-create/template.md` - Generation templates
- `jaan-to/config.md` - Current skill catalog
...
Read `.claude/skills/to-jaan-skill-create/LEARN.md` if it exists:
...
□ .claude/skills/{name}/LEARN.md
□ .claude/skills/{name}/template.md (if needed)

WILL ALSO
─────────
□ Register in jaan-to/config.md
...
Use template from `.claude/skills/to-jaan-skill-create/template.md`:
...
Confirm: "Skill files written to `.claude/skills/{name}/`"

## Step 13: Update Config Catalog

Edit `jaan-to/config.md` to add skill to Available Skills table:
...
```bash
git add .claude/skills/{name}/ jaan-to/config.md docs/skills/{role}/{name}.md
...
- `.claude/skills/{name}/SKILL.md`
- `.claude/skills/{name}/LEARN.md`
- `.claude/skills/{name}/template.md` (if applicable)
- `docs/skills/{role}/{name}.md`
...
- [ ] Registered in jaan-to/config.md
