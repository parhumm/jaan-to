...
- `.claude/skills/to-jaan-research-add/LEARN.md` - Past lessons
...
1. **If empty:** Show usage
   ...
   Examples:
   - /to-jaan-research-add docs/deepresearches/my-research.md
...
Read `.claude/skills/to-jaan-research-add/LEARN.md` if it exists:
