...
| Check | Description |
|-------|-------------|
| Required sections | Compares output against the skill's `template.md` structure |
| STYLE.md compliance | Validates formatting rules from `docs/STYLE.md` |
...
1. Reads the skill's `template.md` to know expected structure
2. Reads `docs/STYLE.md` for formatting rules
