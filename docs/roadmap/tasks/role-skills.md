...
- **Detect → Knowledge**: DETECT (detect-dev + detect-design + detect-writing + detect-product + detect-ux) → detect-pack
...
2. `/data-sql-query` - Rank #2
3. `/pm-story-write` - Rank #6
4. `/ux-research-synthesize` - Rank #8
5. `/qa-bug-report` - Rank #10
6. `/jaan-to-growth-meta-write` - Rank #12
7. `/dev-docs-generate` - Rank #14
8. `/pm-feedback-synthesize` - Rank #15
9. `/ux-persona-create` - Rank #16
10. `/jaan-to-growth-content-optimize` - Rank #18
11. `/data-dbt-model` - Rank #19
12. `/data-cohort-analyze` - (supports funnel analysis)
