...
| Total skill lines | ~18,800 across 45 skills | Median ~440 lines |
...
| **Cumulative** | **~2,400 tokens/session** | **Up to ~56K per invocation** | **45 skills, 23 reference files, 6 CI gates** |
