...
```
/jaan-to:jaan-docs-update [path] [--full] [--fix] [--check-only] [--quick]
```
...
**Full audit**:
```
/jaan-to:jaan-docs-update --full
```

**Full audit with auto-fix**:
```
/jaan-to:jaan-docs-update --full --fix
```

**Check specific path**:
```
/jaan-to:jaan-docs-update docs/skills/ --check-only
```
