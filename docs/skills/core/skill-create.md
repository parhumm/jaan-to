...
```
/to-jaan-skill-create [optional-skill-idea]
```
...
| **Auto-Documentation** | Invokes `/to-jaan-docs-create` automatically |
...
- Use `/to-jaan-skill-update` for modifications after creation
