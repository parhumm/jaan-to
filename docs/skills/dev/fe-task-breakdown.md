...
```
/dev-fe-task-breakdown "User profile redesign with settings modal"
/dev-fe-task-breakdown "https://figma.com/file/abc123"
/dev-fe-task-breakdown "See PRD at jaan-to/outputs/pm/prd/profile-redesign/prd.md"
```
...
```
/jaan-to:dev-tech-plan → /dev-fe-task-breakdown → /jaan-to:dev-fe-state-machine
```
